...
import {
  Pencil, Trash2, Plus, X, Save, Users, FolderPlus,
} from 'lucide-react';
import {
...
const emptyRoleForm = (sectionId: string): Omit<Role, 'id'> => ({
  label: '', sectionId, allowMultiple: false,
});
...
export default function RolesPanel({
  ...
  const openEditRole = (r: Role) => {
    setEditingRole(r);
    setRoleForm({ label: r.label, sectionId: r.sectionId, allowMultiple: !!r.allowMultiple });
    setRoleDialog(true);
  };
